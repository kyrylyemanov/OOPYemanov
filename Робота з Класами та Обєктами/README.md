...
<img width="487" height="401" alt="изображение" src="https://github.com/user-attachments/assets/0281ab8a-f3ea-41bc-b96b-803fa648ca95" />
...
У роботі створено клас Student, що демонструє основні принципи ООП: приховування, властивості, методи класу та статичні методи.
